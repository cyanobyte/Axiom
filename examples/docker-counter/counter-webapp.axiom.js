/**
 * Purpose: Demonstrate the Docker-backed Axiom build runner with a deterministic web app.
 * Responsibilities:
...
export default intent(
  {
    id: "counter-webapp-docker",

    // Basic project identity
    meta: {
      title: "Docker Counter Web App",
      summary: "A tiny full-stack web app that proves Docker-mode Axiom builds.",
      version: "1.0.0",
